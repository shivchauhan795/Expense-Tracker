    ...
    <>
      ...
      <div className='addExpense flex flex-wrap justify-center items-center min-h-[89vh]'>
        <div className='form flex flex-col gap-3'>
          <p className='font-bold uppercase text-3xl'>Add Items</p>
          <div className="inputs flex gap-2 flex-wrap justify-center">
          ...
          <div className="radioButtons flex flex-wrap gap-3">
          ...
          <input className='border border-black cursor-pointer w-auto' type='submit' value="Submit" onClick={handleSubmit} />
        </div>
      </div>
    </>
  );
